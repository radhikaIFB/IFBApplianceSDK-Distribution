...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/radhikaIFB/IFBApplianceSDK-Distribution/releases/download/1.0.1/IFBSDKCore.xcframework.zip",
            checksum: "85c6aeb21f5bf18ee197849da9a83d1504536b2ea5f40e7625f6e19c3a596eb6"
        ),
        .binaryTarget(
            name: "IFBProvisioningSDKBinary",
            url: "https://github.com/radhikaIFB/IFBApplianceSDK-Distribution/releases/download/1.0.1/IFBProvisioningSDK.xcframework.zip",
